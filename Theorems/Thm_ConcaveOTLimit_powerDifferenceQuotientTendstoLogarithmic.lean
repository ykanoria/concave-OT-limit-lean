...
/-- The first difference quotient of the power profile converges from the
right to the logarithmic secondary profile. -/
theorem powerDifferenceQuotientTendstoLogarithmic
    {r : Real} (hr : 0 <= r) :
    Tendsto
      (fun epsilon =>
