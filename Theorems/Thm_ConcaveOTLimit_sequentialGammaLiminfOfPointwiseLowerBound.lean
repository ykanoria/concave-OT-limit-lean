...
/-- A sequentially lower-semicontinuous pointwise minorant supplies the
hereditary liminf half of sequential Gamma convergence. -/
theorem sequentialGammaLiminfOfPointwiseLowerBound
