...
/-- Under stochastic order and an atomless source, a coupling satisfying
Juillet's full-mass monotone-arch conditions moves forward almost everywhere. -/
theorem isForwardPlanOfJuilletExcursionPlan
