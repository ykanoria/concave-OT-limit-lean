...
/-- The power difference quotients admit a uniform logarithmic Orlicz
domination for small positive perturbation parameters. -/
theorem powerDifferenceQuotientOrliczBound
    {epsilon r : Real}
    (hEpsilonPos : 0 < epsilon) (hEpsilonLeHalf : epsilon <= 1 / 2)
    (hr : 0 <= r) :
