...
reductions imply the full one-dimensional excursion variational theorem. -/
theorem oneDimensionalExcursionVariationalOfBadNullAndMapAC
  ...
  · exact juilletIdentificationOfBadNullAndMapACOfExcursionPlan
