...
/-- A uniformly bounded perturbation multiplied by a vanishing parameter
preserves a sequentially continuous functional in the Gamma limit. -/
theorem sequentialGammaOfVanishingUniformPerturbation
