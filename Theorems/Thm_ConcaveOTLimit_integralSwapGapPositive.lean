...
/-- A uniformly positive integrable swap gap has strictly positive integral
against the product of two nonzero finite measures. -/
theorem integralSwapGapPositive
