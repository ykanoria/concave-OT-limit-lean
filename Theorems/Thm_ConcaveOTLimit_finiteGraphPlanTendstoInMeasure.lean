...
/-- Weak convergence of finite graph plans implies convergence in measure
when the limit map has arbitrarily large closed continuity sets. -/
theorem finiteGraphPlanTendstoInMeasure
    {X Y I : Type*}
