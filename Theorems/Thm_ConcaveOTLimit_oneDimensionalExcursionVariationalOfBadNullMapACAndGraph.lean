...
/-- The explicit bad-level, cumulative-pushforward, and graph-plan
assumptions imply the full one-dimensional excursion variational theorem. -/
theorem oneDimensionalExcursionVariationalOfBadNullMapACAndGraph
