...
/-- Juillet's strict-prefix cut (equation (16)): inside a forward arch,
no mass can enter the prefix `(x, t]` from outside its closed prefix
`[x, t]`. -/
theorem monotoneArchPrefixCut
