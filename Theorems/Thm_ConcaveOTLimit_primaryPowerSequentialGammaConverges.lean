...
/-- Sequential continuity of distance and a uniform bound on the integrated
power quotients imply Gamma convergence of the primary power costs. -/
theorem primaryPowerSequentialGammaConverges
