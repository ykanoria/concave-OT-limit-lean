...
/-- Distance optimality is equivalent to attaining the infimum of distance
cost over the fixed-marginal coupling space. -/
theorem isDistanceOptimal_iff_distanceCost_eq_minimal
