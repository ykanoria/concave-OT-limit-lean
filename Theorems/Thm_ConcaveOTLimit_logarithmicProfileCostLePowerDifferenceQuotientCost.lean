...
/-- The scalar lower bound for power difference quotients lifts to the
corresponding integral functionals on every fixed finite coupling. -/
theorem logarithmicProfileCostLePowerDifferenceQuotientCost
