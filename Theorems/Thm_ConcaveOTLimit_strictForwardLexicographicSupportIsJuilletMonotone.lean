...
/-- A strictly forward support satisfying the two-point lexicographic swap
inequalities has all ordered Juillet monotone-arch properties. -/
theorem strictForwardLexicographicSupportIsJuilletMonotone
    {profile : Real -> Real}
    (hProfile : StrictConcaveOn Real (Ici 0) profile)
