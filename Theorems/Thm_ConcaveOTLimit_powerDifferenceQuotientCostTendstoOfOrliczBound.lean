...
/-- Pointwise convergence and an integrable Orlicz bound give convergence of
the power difference-quotient integral on a fixed measure. -/
theorem powerDifferenceQuotientCostTendstoOfOrliczBound
