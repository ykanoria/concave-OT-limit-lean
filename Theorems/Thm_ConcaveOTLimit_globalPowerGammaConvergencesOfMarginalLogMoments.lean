...
/-- For positive exponents tending to zero, the primary and globally
extended rescaled power functionals have their distance/logarithmic Gamma
limits. -/
theorem globalPowerGammaConvergencesOfMarginalLogMoments
