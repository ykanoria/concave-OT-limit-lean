...
/-- Rescaled power costs sequentially Gamma-converge to logarithmic cost on
the distance-optimal face. -/
theorem rescaledPowerSequentialGammaConvergesOnDistanceOptimalFace
