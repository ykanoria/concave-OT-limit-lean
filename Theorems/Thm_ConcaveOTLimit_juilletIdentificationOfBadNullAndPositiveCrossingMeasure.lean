...
/-- Bad-level nullity and an explicit positive-crossing measure identify every
Juillet excursion coupling with a distinguished graph excursion coupling. -/
theorem juilletIdentificationOfBadNullAndPositiveCrossingMeasure
