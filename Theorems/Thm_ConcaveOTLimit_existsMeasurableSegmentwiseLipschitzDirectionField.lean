...
/-- A sigma-compact diagonal-free no-crossing relation admits a globally
measurable canonical direction field that is constant on each generating
open segment. -/
theorem existsMeasurableSegmentwiseLipschitzDirectionField
