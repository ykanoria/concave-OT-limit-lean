...
/-- At a source-atomless abscissa, a good increasing crossing lies at the
right-continuous value of the signed cumulative function. -/
theorem goodIncreasingCrossingLevelEqOfAtomlessAt
