...
/-- On the real line, distance cost is the marginal first-moment difference
plus twice the integrated backward displacement. -/
theorem distanceCostEqMomentDifferenceAddBackward
