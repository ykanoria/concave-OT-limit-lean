...
/-- A full-mass lexicographic support of a forward coupling with mutually
singular marginals can be restricted to a full-mass strictly forward
lexicographic support. -/
theorem existsStrictForwardLexicographicSupport
