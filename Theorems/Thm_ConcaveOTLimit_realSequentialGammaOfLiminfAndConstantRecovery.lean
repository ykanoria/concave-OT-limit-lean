...
/-- Real-valued liminf and constant-recovery statements induce the
extended-real sequential Gamma-convergence structure used by the model. -/
theorem realSequentialGammaOfLiminfAndConstantRecovery
