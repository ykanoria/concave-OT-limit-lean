...
/-- The lintegral of a nonnegative lower-semicontinuous function is lower
semicontinuous on probability measures with the weak topology. -/
theorem probabilityLintegralLowerSemicontinuous
