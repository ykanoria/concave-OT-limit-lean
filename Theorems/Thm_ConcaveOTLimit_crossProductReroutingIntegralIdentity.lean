...
/-- The cost removed by a mass-balanced pair of blocks, minus the cost of
crossing their target marginals, is the product-average of the pointwise swap
gap. -/
theorem crossProductReroutingIntegralIdentity
