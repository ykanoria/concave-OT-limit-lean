...
/-- Two nonnegative masses have a positive common scaling coefficient that
makes both scaled masses at most one. -/
theorem existsPositiveBalancedSwapCoefficient (a b : NNReal) :
