...
/-- The forward face equals the distance-optimal face under the absolute
first-moment assumptions used by the paper theorem. -/
theorem forwardPlansEqDistanceOptimalFaceOfAbsMoments
