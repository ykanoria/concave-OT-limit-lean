...
/-- Marginal logarithmic moments imply sequential Gamma convergence of the
primary power costs to distance cost. -/
theorem primaryPowerGammaConvergesOfMarginalLogMoments
