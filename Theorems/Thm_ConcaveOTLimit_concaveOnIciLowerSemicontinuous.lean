...
/-- A finite concave profile on the nonnegative half-line is lower
semicontinuous there, including at the endpoint zero. -/
theorem concaveOnIciLowerSemicontinuous
    {profile : Real -> Real}
