...
/-- Almost-everywhere Juillet regularity and an explicit positive-crossing
measure imply the full one-dimensional excursion variational theorem. -/
theorem oneDimensionalExcursionVariationalOfJuilletRegularityAndCrossingMeasure
