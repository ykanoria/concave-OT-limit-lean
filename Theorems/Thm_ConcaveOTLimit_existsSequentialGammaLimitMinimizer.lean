...
/-- On a sequentially compact set, exact minimizers have a subsequential
limit that minimizes the sequential Gamma limit on that set. -/
theorem existsSequentialGammaLimitMinimizer
