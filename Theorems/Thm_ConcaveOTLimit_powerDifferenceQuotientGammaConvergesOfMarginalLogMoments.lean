...
/-- Under marginal logarithmic moments, the power difference-quotient
functionals Gamma-converge to the logarithmic transport functional. -/
theorem powerDifferenceQuotientGammaConvergesOfMarginalLogMoments
