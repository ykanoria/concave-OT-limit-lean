...
/-- The logarithmic secondary profile is globally dominated on the
nonnegative half-line by the logarithmic Orlicz profile. -/
theorem absLogarithmicProfileLeOneAddPsi
    {r : Real} (hr : 0 <= r) :
