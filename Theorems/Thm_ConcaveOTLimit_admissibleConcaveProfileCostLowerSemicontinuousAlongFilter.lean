...
/-- On real forward couplings, every admissible concave profile cost is
lower semicontinuous along countably generated weak filters. -/
theorem admissibleConcaveProfileCostLowerSemicontinuousAlongFilter
