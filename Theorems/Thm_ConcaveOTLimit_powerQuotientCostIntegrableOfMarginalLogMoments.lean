...
/-- Marginal logarithmic moments make every small positive power
difference-quotient cost integrable under a finite coupling. -/
theorem powerQuotientCostIntegrableOfMarginalLogMoments
