...
/-- A balanced crossed replacement between two crossed-forward blocks of a
forward coupling is itself a forward coupling. -/
theorem existsForwardBalancedCrossProductReroutingCoupling
