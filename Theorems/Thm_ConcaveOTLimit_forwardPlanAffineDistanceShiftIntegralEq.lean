...
/-- Any two forward couplings of fixed real marginals give the same integral
of an affine shift of distance, for an arbitrary real coefficient. -/
theorem forwardPlanAffineDistanceShiftIntegralEq
