...
/-- Replacing part of a finite measure by another finite measure with the same
marginals preserves both marginals of the whole measure. -/
theorem finiteMeasureReplacementPreservesMarginals
