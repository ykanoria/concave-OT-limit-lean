...
/-- Carrier separation upgrades the weak crossed forwardness forced by a
primary-cost tie to strict crossed forwardness. -/
theorem strictCrossedForwardOfDistanceTieOnCarrier
