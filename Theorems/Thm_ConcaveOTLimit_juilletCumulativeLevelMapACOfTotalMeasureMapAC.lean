...
/-- Absolute continuity of all cumulative levels implies absolute continuity
of the source cumulative levels. -/
theorem juilletCumulativeLevelMapACOfTotalMeasureMapAC
    (mu nu : FiniteMeasure Real)
    (hTotalMapAC :
