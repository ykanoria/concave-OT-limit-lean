...
/-- The primary power cost is exactly the distance cost plus the perturbation
parameter times the power difference-quotient cost. -/
theorem powerProfileCostDecomposition
