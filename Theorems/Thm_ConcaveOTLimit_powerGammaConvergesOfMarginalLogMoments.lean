...
/-- Marginal logarithmic moments discharge all fixed-coupling inputs for
power-quotient Gamma convergence; only moving-coupling lower semicontinuity
remains explicit. -/
theorem powerGammaConvergesOfMarginalLogMoments
