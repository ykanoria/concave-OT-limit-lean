...
/-- Marginal logarithmic moments imply integrability of the logarithmic
transport cost under every finite coupling. -/
theorem logarithmicCostIntegrableOfMarginalLogMoments
