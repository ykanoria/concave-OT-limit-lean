...
/-- The signed cumulative function is right-continuous, and its strict left
limit is the difference of the two measures of the corresponding open
half-line. -/
theorem signedCumulativeRightContinuousAndLeftLim
